...
LANDER_POLY =[(-14,+17), (-17,10), (-27,-10),(+27,-10), (+17,10), (+14,+17)]
...
class LunarLander(gym.Env, EzPickle):
    ...
    def reset(self):
        ...
        #Moon Color
        self.moon.color1 = (0.0,1.0,0.0)
        self.moon.color2 = (0.0,1.0,0.0)
        ...
        for i in [-1,+1]:
            ...
            leg.color1 = (1.0,0.0,1.0)
            leg.color2 = (1.0,0.0,1.0)
    ...
    def _create_particle(self, mass, x, y, ttl):
        p = self.world.CreateDynamicBody(
            ...
            angle=0.0,
            fixtures = fixtureDef(
                shape=circleShape(radius=2/SCALE, pos=(0,0)),density=mass,friction=0.1,
                categoryBits=0x0100,maskBits=0x001,restitution=0.3))
        p.ttl = ttl
